                ...
                <div className="bg-gray-100 dark:bg-gray-900 p-4 relative">
                    ...
                    <div className="grid md:grid-cols-1 gap-4 container mx-auto">
                        {chartSeries.length > 0 ? (
                            ...
                            <>
                                <div className="bg-gray-800 p-4 h-56 flex justify-center items-center">
                                    <h2>No Device Attached</h2>
                                </div>
                            </>
                        )}
                        ...
                        <Link
                            ...
                            href={route("full-maintenance-suite")}
                        >
                            settings
                        </Link>
                    ...
                    users.map((user, index) => (
                        <div className="relative left-24">
                            ...
                            >
                                <span>
                                    <Link
                                        href={route("userAccount.show", {
                                            userID: namesRoute[index],
                                        })}
                                    >
                                        {user.substring(0, 1)}
                                    </Link>
